	...
	return (
		<>
			<div className="flex flex-col items-center w-full min-h-screen p-3 bg-isGrayLightEmphasis6 place-content-start">
				...
				<div className="flex flex-col w-full h-full max-w-6xl space-y-3">
					...
					{index.sections.map((section, key) => {
						return (
							...
							>
								...
								>
									<div className="px-5 pt-4 text-lg font-bold leading-5 transition duration-300 ease-in-out group-hover:text-isWhite text-isGrayDarkEmphasis3">
										{index[section].title}
									</div>

									{/* <div className="flex flex-row items-center px-3 text-sm font-medium transition duration-300 ease-in-out md:px-5 text-isGrayDark2 group-hover:text-isWhite">
									...
									<div className="px-5 pb-4 font-medium leading-5 transition duration-300 ease-in-out text-md text-isGrayDarkEmphasis group-hover:text-isWhite">
