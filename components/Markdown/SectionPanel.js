		...
		<>
			<div className="flex flex-col w-full mb-[12px] place-content-center items-center">
				...
				>
					...
					<div className="flex flex-row items-center group bg-isGreenDark delay-50 duration-300 ease-in-out py-[3px] md:py-[4px] lg:py-[5px] px-[7px] md:px-[8px] lg:px-[9px] rounded-md md:rounded-lg lg:rounded-xl">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
							fill="currentColor"
